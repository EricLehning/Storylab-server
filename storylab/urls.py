...
from storylabapi.views import SeedView, CharacterView, ConsequenceView, DesireView, FearView, GenreView, ObstacleView, RewardView, WriterView, ChatbotView, OutlineView
...
router.register(r'outlines', OutlineView, 'outline' )
